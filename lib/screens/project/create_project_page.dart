...
class CreateProjectPage extends StatelessWidget {
        ...
        builder: (_) {
          return Scaffold(
            ...
            body: Stack(
              ...
              children: [
                Padding(
                  padding: isDesktop ? EdgeInsets.zero : EdgeInsets.symmetric(horizontal: $style.insets.$16),
                      ...
                      switch (index) {
                        ...
                        case 2:
                          return questionForText(
                            ...
                            question: isDesktop ? '제품이나 서비스의 핵심 가치를 설명하는 문장' : '제품이나 서비스의 핵심 가치를\n설명하는 문장',
                        ...
                        case 4:
                          return descriptionQuestionWidget(isDesktop);
                        case 5:
                          return questionForCallToAction(isDesktop);
                        case 6:
                          return Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              const Spacer(),
                              questionText('키 컬러를 설정해 주세요.'),
                              Gap($style.insets.$24),
                              SizedBox(
                                width: 280 * sizeUnit,
                                child: Wrap(
  ...
  // call to action 질문
  Widget questionForCallToAction(bool isDesktop) {
    Widget selectionBox({required String type, String? text}) {
      ...
      return InkWell(
        ...
        child: Container(
          width: isDesktop ? 320 * sizeUnit : 108 * sizeUnit,
          height: isDesktop ? 120 * sizeUnit : 100 * sizeUnit,
          decoration: BoxDecoration(
            border: Border.all(
              width: 1 * sizeUnit,
            ...
            children: [
              Text(
                ...
                style: $style.text.headline20.copyWith(
                  fontSize: isDesktop ? null : 16 * sizeUnit,
                  color: isSelected ? controller.colorScheme.onPrimaryContainer : null,
                ),
              ),
              if (text != null) ...[
                ...
                Text(
                  ...
                  style: $style.text.subTitle12.copyWith(
                    fontSize: isDesktop ? null : 12 * sizeUnit,
                    color: isSelected ? controller.colorScheme.onPrimaryContainer : null,
                  ),
    ...
    Widget callbackDetailWidget() {
      Widget detailSelectionBox({required String type}) {
        ...
        return InkWell(
          ...
          borderRadius: BorderRadius.circular($style.corners.$12),
          child: Container(
            width: isDesktop ? 160 * sizeUnit : 100 * sizeUnit,
            height: 80 * sizeUnit,
            decoration: BoxDecoration(
              border: Border.all(
                width: 1 * sizeUnit,
        ...
        case UserCallback.typeForm:
          return Row(
            ...
            children: [
              ...
              Gap(isDesktop ? $style.insets.$12 : $style.insets.$8),
          ...
          child: GetBuilder<CreateProjectController>(
              ...
              builder: (_) {
                return Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    questionText('Call To Action'),
                    Gap($style.insets.$12),
                    subQuestionText('사용자에게 받을 콜 투 액션 타입을 선택해 주세요.'),
                    Gap($style.insets.$40),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        Gap(isDesktop ? $style.insets.$24 : $style.insets.$8),
                        selectionBox(
  ...
  Widget descriptionQuestionWidget(bool isDesktop) {
    // 핵심 기능 질문
    Center questionForDescription({
      required int index,
      ...
      Widget imgBox() {
        ...
        return Obx(() => imgSelectionBox(
              width: isDesktop ? 612 * sizeUnit : 400 * sizeUnit,
              height: isDesktop ? 457 * sizeUnit : 340 * sizeUnit,
              xFile: xFile.value,
              onCancel: () {
      ...
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            if (!isDesktop) Gap($style.insets.$24),
            questionText(question),
            Gap($style.insets.$12),
            subQuestionText('제품이나 서비스의 핵심 기능에 대해 설명해 주세요.'),
            Gap($style.insets.$40),
            if (isDesktop) ...[
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                            ...
                            children: [
                              Column(
                                children: [
                                  ...
                                  Gap(isDesktop ? $style.insets.$40 : $style.insets.$4),
                                ],
                              ),
  ...
  Text subQuestionText(String subQuestion) => Text(
        subQuestion,
